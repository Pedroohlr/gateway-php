...
return new class extends Migration {
    ...
    {
        Schema::create('blupay', function (Blueprint $table) {
            $table->id();
            $table->string('url')->nullable()->default('https://api.blupayip.io');
            $table->string('username')->nullable()->default(NULL);
            $table->string('password')->nullable()->default(NULL);
            $table->string('idempotency_key')->nullable()->default(NULL);
