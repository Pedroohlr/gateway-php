<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand gap-3">
            <div class="mobile-toggle-menu" onclick="openSidebar()"><i class="bx bx-menu"></i>
            </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <p class="msg-header-badge">0 Novas</p>
                                </div>
                            </a>
                            ...
                            <a href="javascript:;">
                                <div class="text-center msg-footer">
                                    <button class="btn btn-light w-100">Todas as notificações</button>
                                </div>
                            </a>
                        </div>
                    </li>
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="/my-profile"><i
                    ...
                    <li>
                        ...
                        <button type="submit" class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                class="bx bx-log-out-circle"></i><span>Sair</span></button>
                                </form>
                    </li>
                </ul>
            </div>
