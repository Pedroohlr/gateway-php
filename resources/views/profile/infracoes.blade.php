                                    ...
                                    <td>
                                        @if ($infracao->status == 'OPEN')
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalApelo">Defender-me</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalApeloLabel">Minha defesa</h5>
                    ...
                    <form method="POST" action="{{ route('profile.relatorio.infracoes.defesa') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="appeal" class="form-label">Apresente sua defesa</label>
                                <textarea class="form-control" id="appeal" name="appeal"
                                    rows="3">Nao foi feita cobranca indevida</textarea>
                                <small class="text-white">Utilize poucas palavras apresentando sua defesa.</small>
                            </div>
                        </div>
